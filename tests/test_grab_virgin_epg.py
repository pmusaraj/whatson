...
from scripts.grab_virgin_epg import build_guide, xmltv_time


class VirginGuideTest(unittest.TestCase):
    def test_shared_segments_keep_channels_separate_and_deduplicate_boundaries(self):
        ...
        def listing(channel_id, title):
            return {"channelId": channel_id, "events": [{
                "title": title, "startTime": 1789488000, "endTime": 1789491600,
    ...
    def test_offsets_and_seconds_convert_to_utc(self):
        self.assertEqual(xmltv_time("2026-09-15T23:00:00+02:00"), xmltv_time(1789506000))
